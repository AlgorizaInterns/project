      ...
      <div className="section">
        <div class="section-header">
          <div class="right-side">
            <h1>Filters</h1>
            | <fa class="blue-icon" icon="home" /> <fa icon="angle-right" />
            <a href="#">ECommerce</a> <fa icon="angle-right" /> Shop
          </div>

          <div class="left-side">
            <button class="btn"><fa icon="gear" /></button>
          </div>
        </div>

        <menu-bar @fire="getPriceFiltered" @play="getBrandFiltered" />
...
export default {
  name: "App",
  components: { SideBar, NavBar, MenuBar, ProductCard },
  mounted: function () {
    this.getFiltered();
  },
  data() {
  ...
  methods: {
    getFiltered() {
      ...
      this.filteredProduct = this.products.filter((r) => {
        // let pos = r.name.toLowerCase().search(this.searchtext.toLowerCase());
        // if(pos == -1){
        //   return false;
        // } else {
        //   return true;
        // }
        return r.name.toLowerCase().startsWith(this.searchtext.toLowerCase());
      });
      if (this.filteredProduct) this.filteredProduct;
      else this.filteredProduct = this.products;
    },
    getPriceFiltered(price) {
      this.filteredPrice = price;
      // if(this.filteredPrice == 0) {
      //   this.filteredProduct = this.products;
      //   return;
      // }
      // if(this.filteredPrice == 1) {
      //   this.filteredProduct = this.products.filter(r => r.price <= 10)
      //   return;
      // }
      // if(this.filteredPrice == 2) {
      //   this.filteredProduct = this.products.filter(r => r.price > 10 && r.price <= 100 )
      //   return;
      // }
      // if(this.filteredPrice == 3) {
      //   this.filteredProduct = this.products.filter(r => r.price > 100 && r.price <= 500 );
      //   return;
      // }
      // if(this.filteredPrice == 4) {
      //   this.filteredProduct = this.products.filter(r => r.price > 500 );
      //   return;
      // }
    ...
    getBrandFiltered(brand) {
      ...
      if (!this.filteredbrand) {
        ...
        this.filteredProduct = this.products.filter((r) => r.brand == this.filteredbrand);
        return;
      }
    },
  },
